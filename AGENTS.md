...
[Echo] Before any task, read `.antigravity/memories/patterns_and_lessons.md`. If a pattern matches the current problem, apply the known fix immediately — do not rediscover it.
